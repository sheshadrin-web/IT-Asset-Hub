...
export default function DeviceAgentCard({ assetId, assetTag }: Props) {
  ...
  // Keep the copied command short and one-line. The actual repair logic is
  // hosted separately so PowerShell clipboard/newline handling cannot corrupt
  // a long script before it starts executing.
  const repairCmdWindows =
    `irm "https://it.assets.mileseducation.org/agent/repair.ps1" | iex`;
