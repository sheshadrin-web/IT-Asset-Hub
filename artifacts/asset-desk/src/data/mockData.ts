...
export const mockUsers: User[] = [
  { userId: "USR-001", name: "Sarah Mitchell", email: "admin@demo.com",   role: "super_admin", department: "IT",          assignedAssets: 2, status: "Active" },
  { userId: "USR-002", name: "James Thornton", email: "agent1@demo.com",  role: "agent",       department: "IT",          assignedAssets: 1, status: "Active" },
  ...
  { userId: "USR-006", name: "Laura Bennett",    email: "laura.b@demo.com", role: "end_user",    department: "Finance",     assignedAssets: 1, status: "Active" },
  { userId: "USR-007", name: "Marcus Johnson",   email: "marcus@demo.com",  role: "end_user",    department: "Engineering", assignedAssets: 2, status: "Active" },
  { userId: "USR-008", name: "Sofia Rossi",      email: "sofia@demo.com",   role: "end_user",    department: "HR",          assignedAssets: 1, status: "Inactive" },
...
export const mockAssets: Asset[] = [
  ...
  { assetId: "AST-011", assetType: "Mobile",  brand: "Apple",   model: "iPhone 13",          serialNumber: "APIPH13011",  imeiNumber: "491287340012345", purchaseDate: "2022-01-15", warrantyEndDate: "2024-01-15", status: "Lost",     department: "HR",          location: "Unknown",           accessories: "Charger",                  remarks: "Reported lost by Sofia Rossi" },
...
export const mockTickets: Ticket[] = [
  {
    ...
    comments: [
      { id: "c1", author: "James Thornton", role: "agent", text: "Ran diagnostics - found malware and excessive startup items. Starting cleanup.", date: "2024-11-16" },
    ]
  },
  {
  ...
  },
  {
    ...
    comments: [
      ...
      { id: "c3", author: "Laura Bennett", role: "end_user", text: "I have a presentation on Nov 20th - please prioritize.", date: "2024-11-12" },
  ...
  },
  {
    ...
    comments: [
      { id: "c5", author: "Raj Patel", role: "agent", text: "Known issue with v3.2.0. Pushed v3.2.1 update to your device.", date: "2024-11-05" },
    ]
  },
  {
  ...
  },
  {
    ...
    comments: [
      { id: "c8", author: "Sarah Mitchell", role: "super_admin", text: "Device is still under warranty. Sending to manufacturer for service instead.", date: "2024-11-07" },
    ]
  },
];
